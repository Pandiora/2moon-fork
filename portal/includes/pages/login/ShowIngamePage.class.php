...
class ShowIngamePage extends AbstractLoginPage
{
	...
	function show() 
	{
		...
		if(!$session->isValidSession())
		{
			...
			header('Location: https://'.$universe.'.'.config::get()->domain_name.'/check.php?referralID='.$AccountInf['ref_id'].'&email='.$AccountInf['email'].'&username='.$AccountInf['username'].'&lang='.$AccountInf['lang'].'&userId='.$AccountInf['id'].'&encodingplayer='.$AccountInf['encodage'].'&password='.$AccountInf['password'].''); 
